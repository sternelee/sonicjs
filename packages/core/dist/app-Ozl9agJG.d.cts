...
export { type Bindings as B, type SonicJSApp as S, type Variables as V, type SonicJSConfig as a, setupCoreRoutes as b, createSonicJSApp as c, setupCoreMiddleware as s };
