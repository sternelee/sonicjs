...
3. ⏳ Migrate dependent subsystems (remaining blockers): **workflow plugin** → operate on the documents two-axis model (the long pole, + `content_versions`); **AI search indexer** → index documents.
