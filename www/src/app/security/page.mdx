...
- `Content-Security-Policy` — restricts resource loading (not set by default; configure via middleware if needed)
- `X-Content-Type-Options: nosniff` — prevents MIME sniffing
- `X-Frame-Options: SAMEORIGIN` — prevents clickjacking, allows same-origin iframe embedding
...
|---------|------|---------|
| v3.0.0-beta | Jun 2026 | Better Auth session hardening, document-backed RBAC, HTTP-only auth_token cookie |
