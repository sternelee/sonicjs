...
### Authentication
- ~~Better Auth (session + JWT API tokens) + document-backed RBAC~~
...
- ~~Rich Text fields (Lexical default; TinyMCE/Quill/MDX optional)~~
...
### Plugin SDK
- ~~Plugin SDK: definePlugin() + registerPlugins()~~
...
- ~~First-class multi-tenant support (tenant switcher, role-based membership, email invitations)~~
...
- ~~Rich text editor (Lexical default; TinyMCE/Quill/MDX optional)~~
