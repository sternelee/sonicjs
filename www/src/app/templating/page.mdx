...
│   ├── admin-layout-v2.template.ts      # Main admin layout (legacy; new admin pages use the catalyst layout)
│   ├── admin-layout-catalyst.template.ts # Catalyst-based admin UI
│   └── docs-layout.template.ts          # Documentation layout (this file does not exist in v3)
...
```
Layout (admin-layout-v2.template.ts) [legacy; new admin pages use the catalyst layout]
