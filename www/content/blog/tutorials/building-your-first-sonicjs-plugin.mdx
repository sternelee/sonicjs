...
The full Plugin Development Guide is at [/plugins/development](/plugins/development) — it covers hooks, capabilities, cron support, and admin interface patterns.
